A Weather App built using XML to design user interface and Java to handle Task Management. I have used an API key from openweathermap website to get the weather information.
